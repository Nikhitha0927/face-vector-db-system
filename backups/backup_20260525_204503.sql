...
\restrict dF7QMPfTeeXRluHF12jn1O7WmN1NDJCyLpcxUQmGtDTsbw7ZcL5rws6YBvAWBh5
...
ba826138-054b-4cba-81d3-2bdef354b768	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	CREATE	2026-05-25 19:29:03.436524+05:30	persons	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	\N	\N	"{'employee_code': 'EMP101', 'full_name': 'Nikhitha', 'email': 'nikhitha@gmail.com', 'department': 'AI', 'role': 'employee', 'password_hash': 'hashed_password'}"	\N	\N	\N	2026-05-25 19:29:03.436524+05:30
61e7d2aa-3383-45ce-b3b6-74de26f8504f	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	UPDATE	2026-05-25 19:29:03.442207+05:30	persons	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	\N	\N	"{'full_name': 'K Nikhitha', 'department': 'AI Research'}"	\N	\N	\N	2026-05-25 19:29:03.442207+05:30
17944ec3-bcd5-434c-93b7-ff83bd0cb5f7	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	DELETE	2026-05-25 19:29:03.444682+05:30	persons	1de6f12a-0334-4c00-84f8-ca2a2a170c2a	\N	\N	"{\\"deleted\\": true}"	\N	\N	\N	2026-05-25 19:29:03.444682+05:30
\.
...
1de6f12a-0334-4c00-84f8-ca2a2a170c2a	EMP101	K Nikhitha	nikhitha@gmail.com	\N	AI Research	employee	hashed_password	t	t	2026-05-25 19:29:03.444682+05:30	\N	\N	\N	\N	\N	2026-05-25 19:29:03.436524+05:30	2026-05-25 19:29:03.444682+05:30
\.
...
--
-- Name: faces trg_faces_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_faces_updated_at BEFORE UPDATE ON public.faces FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: geofence trg_geofence_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_geofence_updated_at BEFORE UPDATE ON public.geofence FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: persons trg_persons_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_persons_updated_at BEFORE UPDATE ON public.persons FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
\unrestrict dF7QMPfTeeXRluHF12jn1O7WmN1NDJCyLpcxUQmGtDTsbw7ZcL5rws6YBvAWBh5
